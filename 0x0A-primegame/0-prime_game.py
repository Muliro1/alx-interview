...
def generatePrimeNumbers(limit):
    ...
    Args:
        limit (int): The upper limit of the range of numbers to check for primality
...
def isWinner(numRounds, roundValues):
    ...
    Args:
        ...
        roundValues (list): The list of number of prime numbers to generate in each round.
